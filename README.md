...
PB8和PB9是我后面给OLED显示屏的，这里提前配置好了，我的本意也是用OLED测试的但是死活没有发现问题又开了这个板载小灯，至于为啥没发现问题，哈哈是因为我用的是TIM4做HAL库时钟，而这个时候我还没有发现我的板子不是C8T6而是C6T6，C6T6压根没有TIM4自然导致程序异常。（这个后文也会提到哈哈）
